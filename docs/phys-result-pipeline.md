...
| `model` | text | 선택 | `claude-opus-4-8`(기본)·`claude-sonnet-5`·GPT(`gpt-5.5`/`gpt-5.4`/`gpt-5.4-mini`) |
...
- 기본값: `claude-opus-4-8`
- `server.js` whitelist: `claude-opus-4-8`(기본)·`claude-sonnet-5`. 단, `phys-result`는 GPT(`gpt-5.5`/`gpt-5.4`/`gpt-5.4-mini`)도 허용
