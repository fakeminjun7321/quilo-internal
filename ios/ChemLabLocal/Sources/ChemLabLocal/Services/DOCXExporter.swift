...
struct DOCXExporter {
    func writeReport(title: String, bodyMarkdown: String) throws -> URL {
        ...
        try add("word/styles.xml", stylesXML, to: archive)
