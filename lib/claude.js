 ...
 */
async function generateReportContent({ pdfBuffer, date, onProgress = () => {}, signal }) {
...
최종 출력은 단 하나의 \`\`\`json ... \`\`\` 코드 블록입니다.`,
  ...
  // Attach cost info as non-content metadata (docx generator ignores keys it doesn't know)
