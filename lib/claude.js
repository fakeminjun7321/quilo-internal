...
// 16K로는 복잡한 실험(이론 키워드 많은 경우)에서 잘릴 때가 있음.
// 24K로 여유 확보. Sonnet 4.6 최대 출력은 64K이므로 안전하고,
// 실제 사용량은 모델이 필요한 만큼만 쓰므로 평소엔 비용 차이 거의 없음.
const MAX_TOKENS = parseInt(process.env.MAX_TOKENS || "24000", 10);
