...
//
// 배경: Qwen(DashScope) 같은 저가·고성능 모델은 중국 서버로 데이터가 전송된다.
// 사용자가 동의하면 보고서 생성에 쓸 수 있게 하되(server.js 의 foreignConsent 게이트),
// **개인정보는 절대 전송하지 않는다**는 원칙을 지키기 위해 전송 직전 텍스트를 스크럽한다.
//
// 중요 — 데이터 무결성:
