...
4. **사람이 읽는 모든 텍스트는 한국어**로: 보고서 제목, 표 헤더(data_table.headers), 실험명(experiments[].name), 캡션, 본문, 분석, 그리고 **차트 안 텍스트(chart 의 title/x_label/y_label/x_values/series.label/trendline.label)도 한국어**로 작성(서버 렌더러가 NanumGothic 한글 폰트를 지원하므로 차트도 한글로 렌더된다). 단위·변수 기호(°C, mL, N, m/s², 1/T, ln P, mω²)는 그대로 둔다. 표·제목·실험명·차트 라벨을 영어로 쓰지 말 것 — 예: "각도 vs 시간", "시간 (s)", "측정값", "이론값", "선형 회귀".
