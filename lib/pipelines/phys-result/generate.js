...
⚠️ **언어 규칙**: report.title·experiments[].name·data_table.headers·caption·본문·분석은 **반드시 한국어**로 쓰세요. 영어 ASCII는 chart 이미지 안 텍스트(title/x_label/y_label/series.label/trendline.label)에만 허용됩니다. 표 헤더·실험명·제목을 영어로 두지 마세요.
⚠️ **실험 파트 매핑**: 엑셀/CSV의 각 시트, 또는 명확히 구분되는 각 측정 조건(트랙·시편·질량조건 등)은 experiments[]의 독립 항목으로 1:1 매핑하세요. 시트/조건을 임의로 병합하거나 누락하지 마세요.`;
  content.push({
    type: "text",
