...
const PRICING = {
  ...
  // Alibaba Qwen (USD/1M, DashScope OpenAI 호환). ⚠ 중국 서버. Qwen-Flash 초저가.
  "qwen-flash": { input: 0.05, output: 0.4, cache_write: 0.05, cache_read: 0.005 },
  "qwen-plus": { input: 0.4, output: 1.2, cache_write: 0.4, cache_read: 0.04 },
};
...
const MODEL_CREDITS = {
  ...
  "gemini-3.1-pro": 2,
  "gemini-2.5-flash": 1,
  // Qwen(⚠중국): Flash 초저가 1크레딧. plus 도 저가라 1.
  "qwen-flash": 1,
  "qwen-plus": 1,
};
...
// 예산 티어(FLUX.1 schnell 등, IMAGE_BUDGET_* env 설정 시): 장식·단순 도해용. 약 10배 저렴.
const IMAGE_GENERATION_BUDGET_PRICE = 0.003;
