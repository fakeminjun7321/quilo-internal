...
const PRICING = {
  ...
  // Moonshot Kimi (USD/1M, OpenAI 호환). ⚠ 중국 서버. kimi-latest 비전 지원·자동 컨텍스트.
  "kimi-latest": { input: 0.6, output: 2.5, cache_write: 0.6, cache_read: 0.15 },
