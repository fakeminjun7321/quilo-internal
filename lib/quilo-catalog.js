...
const FEATURES = [
  ...
  feature("word-count", "글자수 세기", "translate", "텍스트의 글자수와 분량을 브라우저 또는 API에서 계산합니다.", "/tools/word-count.html", { kind: "browser-tool", status: "active", audience: "public", execution: "hybrid", api: "tools:read" }),
  ...
  feature("regression", "선형회귀·추세선", "translate", "데이터에서 회귀식과 결정계수를 브라우저 또는 API에서 계산합니다.", "/tools/regression.html", { kind: "browser-tool", status: "active", audience: "public", execution: "hybrid", api: "tools:read" }),
  ...
  feature("graph", "그래프 생성기", "translate", "데이터로 산점도·선·막대그래프를 브라우저 또는 API에서 만듭니다.", "/tools/graph.html", { kind: "browser-tool", status: "active", audience: "public", execution: "hybrid", api: "tools:read" }),
  ...
  feature("equation", "LaTeX→한글 수식", "translate", "HWPX 문서 안의 LaTeX와 Quilo 수식 마커를 한글 수식 객체로 일괄 변환합니다.", "/equation/", { kind: "browser-tool", status: "active", audience: "public", api: "documents:write" }),
  feature("image-ocr", "이미지 OCR", "translate", "사진·스크린샷의 글, 표와 수식을 읽어 Markdown과 구조 블록으로 추출합니다.", "/tools/convert.html", { kind: "api-tool", status: "pro", audience: "pro", api: "documents:write" }),
  feature("pdf-analysis", "PDF 분석", "translate", "번역하지 않고 페이지·텍스트층·스캔 여부·수식 밀도와 레이아웃 특성만 분석합니다.", "/translate.html", { kind: "api-tool", status: "active", audience: "member", api: "documents:read" }),
  feature("community", "커뮤니티", "community", "건의·기능 요청·댓글과 운영 소통을 한곳에서 관리합니다.", "/community.html", { kind: "community", status: "active", audience: "member", api: "community:read" }),
  ...
  feature("google-drive", "Google Drive 연동", "account", "사용자 OAuth 권한으로 Drive 파일을 조회하고 결과물을 업로드합니다.", "/#settings", { kind: "integration", status: "active", audience: "member", api: "integrations:write" }),
  feature("google-docs", "Google Docs 연동", "account", "Quilo 결과와 텍스트를 편집 가능한 Google 문서로 만듭니다.", "/#settings", { kind: "integration", status: "active", audience: "member", api: "integrations:write" }),
  feature("notion", "Notion 연동", "account", "Quilo 내용을 사용자의 Notion workspace 페이지로 저장합니다.", "/#settings", { kind: "integration", status: "active", audience: "member", api: "integrations:write" }),
...
module.exports = { CATEGORIES, FEATURES, inferExecution, listFeatures, getFeature };
