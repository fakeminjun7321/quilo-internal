...
const FEATURES = [
  ...
  feature("image-ocr", "이미지 OCR", "translate", "사진·스크린샷을 3중 비교 판독하고 원본 그림을 보존한 DOCX·HWPX·HTML·TXT로 내보냅니다.", "/tools/image-ocr.html", { kind: "workspace", status: "pro", audience: "pro", api: "documents:write" }),
