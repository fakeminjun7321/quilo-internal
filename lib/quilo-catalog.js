...
const FEATURES = [
  ...
  feature("vocabulary-book", "단어장 메이커", "study", "영어 교재 PDF에서 출처가 확인된 핵심 용어·학술 어휘·문제 풀이 표현을 골라 영한 단어장과 단원 평가를 만듭니다.", "/?report=vocabulary-book", { kind: "pipeline", status: "pro", audience: "pro", formats: ["pdf", "json", "zip"], api: "reports:write" }),
  ...
  feature("equation", "LaTeX→한글 수식", "translate", "HWPX 문서 안의 LaTeX와 Quilo 수식 마커를 한글 수식 객체로 일괄 변환합니다.", "/equation/index.html", { kind: "browser-tool", status: "active", audience: "public", api: "documents:write" }),
  feature("image-ocr", "이미지 OCR", "translate", "사진·스크린샷의 글, 표와 수식을 읽어 Markdown과 구조 블록으로 추출합니다.", "/tools/image-ocr.html", { kind: "workspace", status: "pro", audience: "pro", api: "documents:write" }),
  feature("pdf-analysis", "PDF 분석", "translate", "번역하지 않고 페이지, 텍스트층, 스캔 여부, 수식 밀도와 레이아웃 특성만 분석합니다.", "/developers.html#catalog", { kind: "api-tool", status: "active", audience: "member", api: "documents:read" }),
