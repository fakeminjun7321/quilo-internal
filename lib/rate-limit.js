...
const GLOBAL_HOURLY_COST_USD = Math.max(0, Number(process.env.GLOBAL_HOURLY_COST_USD) || 50);
...
function checkCostCircuitBreaker(userId) {
  ...
  return {
    ...
    userTripped: USER_HOURLY_COST_USD > 0 && userUsd >= USER_HOURLY_COST_USD,
    globalUsd,
    userUsd,
    userLimit: USER_HOURLY_COST_USD,
