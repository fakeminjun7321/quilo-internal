...
const PATCH_NOTES = [
  ...
  {
    date: "2026-05-19",
    title: "물리 결과보고서 Capstone 그래프 우선 사용",
    type: "물리 결과",
    items: [
      ".cap 파일 내부의 Capstone 그래프/피팅 화면을 vision 입력과 보고서 그림 후보로 자동 추가",
      "사용자가 Capstone에서 선택한 구간, fit box, 피팅식, RMSE가 보이면 서버가 새로 그린 chart보다 우선 활용하도록 프롬프트 수정",
      "중복 그래프 생성을 줄여 5페이지 제한을 지키기 쉽게 개선",
    ],
  },
  {
    date: "2026-05-19",
