...
colors:
  ...
  text-muted: "#5D6879"
  text-light: "#9A9A9A"
  accent-light: "rgba(33, 95, 229, 0.08)"
  accent-medium: "rgba(33, 95, 229, 0.15)"
  border: "rgba(33, 95, 229, 0.2)"
  card-bg: "rgba(33, 95, 229, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Pretendard** (display) / **Apple SD Gothic Neo** (body); ignore any preset font name lingering in prose.
